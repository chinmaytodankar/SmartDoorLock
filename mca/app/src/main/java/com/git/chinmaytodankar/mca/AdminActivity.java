...
public class AdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button manageUser = findViewById(R.id.manageusers);
        ...
        String doorStat = prevVals.getString("doorStat");
        if (doorStat.matches("ON")) {
                    ...
                    try {
                        ...
                        subToken.setActionCallback(new IMqttActionListener() {
                            ...
                            public void onFailure(IMqttToken asyncActionToken,
                                ...
                                Toast.makeText(AdminActivity.this,"Subscription Failed!",Toast.LENGTH_SHORT).show();
        ...
        viewLog.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AdminActivity.this, ViewLogActivity.class);
                startActivity(intent);
            }
        });
    }
    private boolean isNetworkAvailable() {
        ...
        if ((info == null || !info.isConnected() || !info.isAvailable())) {
            internet = false;//sin conexion
        } else {
            internet = true;//conexión
        }
